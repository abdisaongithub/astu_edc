    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('startup_create') }}"><i class="fas fa-user-circle"></i>Add New
                        Startup</a>
                    <a class="nav-link" href="{{ route('news_create') }}"><i class="fas fa-user-circle"></i>Add New News</a>
                    <a class="nav-link" href="{{ route('testimonial_create') }}"><i
                            class="fas fa-user-circle"></i><span>Add Testimonial</span></a>
                    <a class="nav-link" href="{{ route('team_create') }}"><i class="fas fa-user-circle"></i><span>Add New Team Member</span></a>
                    <a class="nav-link" href="{{ route('partner_create') }}"><i class="fas fa-user-circle"></i><span>Add New Partner</span></a>
                </li>
            </ul>
