        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Business and Entrepreneurship training</a>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Holistic Business Idea Development</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Business Incubation</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Access to funding for startups</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('services') }}">Access to resources for startups</a></li>
                    </ul>
                </div>
